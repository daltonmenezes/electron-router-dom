        ...
        <div className="inline-flex gap-2">
          ...
          <Popover>
            ...
            <PopoverContent className="md:max-w-lg w-screen">
              ...
              **Notas:**
              - Se a URL foi definida na função `createElectronRouter`, então você não precisa definir essa propriedade,
                caso defina, ela será usada em vez da URL definida na função `createElectronRouter`.
